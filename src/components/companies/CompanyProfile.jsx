...
import GlobeContactIcon from "../icons/GlobeContactIcon";
import MailContactIcon from "../icons/MailContactIcon";
import PhoneContactIcon from "../icons/PhoneContactIcon";
import MapPinContactIcon from "../icons/MapPinContactIcon";
									...
									<div className="flex gap-2">
										<button className="btn btn-outline" onClick={handleShare}>
											<svg
												...
												strokeLinejoin="round"
												data-lucide="share-2"
												className="lucide lucide-share-2 h-4 w-4 mr-2"
											>
									...
									{company.socialLinks?.linkedin && (
										...
										>
											<svg
												...
												className="lucide lucide-linkedin h-5 w-5 text-[hsl(var(--color-muted-foreground))]"
											>
									...
									{company.socialLinks?.facebook && (
										...
										>
											<svg
												...
												className="lucide lucide-facebook h-5 w-5 text-[hsl(var(--color-muted-foreground))]"
											>
									...
									{company.socialLinks?.twitter && (
										...
										>
											<svg
												...
												strokeLinejoin="round"
												data-lucide="twitter"
												className="lucide lucide-twitter h-5 w-5 text-[hsl(var(--color-muted-foreground))]"
											>
									...
									{company.socialLinks?.instagram && (
										...
										>
											<svg
												...
												className="lucide lucide-instagram h-5 w-5 text-[hsl(var(--color-muted-foreground))]"
											>
									...
									{company.socialLinks?.github && (
										...
										>
											<svg
												...
												strokeLinejoin="round"
												data-lucide="github"
												className="lucide lucide-github h-5 w-5 text-[hsl(var(--color-muted-foreground))]"
											>
